...
import { hardFacts } from "@/data/facilities";
              ...
              {hardFacts.map((fact, index) => (
                ...
                >
                  <Link
                    ...
                    className="group bg-black p-8 flex flex-col items-center text-center relative hover:bg-black/90 transition-colors w-full h-full"
                  >
