        ...
        <div className="flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center flex-1 justify-end">
            ...
            >
              <Button
                asChild
                className="ml-6 bg-primary hover:bg-primary/90 text-black h-[48px] px-8 text-base border border-white"
              >
        ...
        {isMenuOpen && (
          <div className="lg:hidden mt-6 pb-6 border-t border-gray-200 pt-6 bg-white -mx-6 px-6">
            <div className="flex flex-col gap-4">
              ...
              <Button 
                asChild 
                className="w-full mt-4 bg-primary hover:bg-primary/90 text-black h-[52px] px-16 text-base"
              >
                <a
