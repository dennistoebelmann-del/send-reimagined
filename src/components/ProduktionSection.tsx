  ...
  return (
    <section className="relative min-h-[70vh] bg-black overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-r from-black/30 via-black/50 to-black/90" />
      </div>
      ...
      <div className="relative container mx-auto px-6 py-24 md:py-32 flex items-center min-h-[70vh]">
        <div className="ml-auto w-full lg:w-1/2 lg:pl-12">
          <motion.div
            ...
            className="space-y-6"
          >
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-white italic">
              Sendesaal Productions
            </h2>
            ...
            <p className="text-gray-300 text-lg leading-relaxed max-w-xl">
              ...
              einzigartigen akustischen Umgebung. Ein Raum, in dem Musiker kompromisslos an 
              ihrer künstlerischen Vision arbeiten können.
            </p>
            ...
            <Link to="/ueber-uns#akustik">
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="bg-primary hover:bg-primary/90 text-primary-foreground font-semibold px-8 py-3 transition-colors duration-300"
              >
